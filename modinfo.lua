...
local hunger_options_zht =
{
    ...
    {
        "更 Minecraft 的飽食度",
        "主選項。關閉後，下方全部子功能和角色補償均不生效。",
    },
    mc_hunger_regen =
    {
        "  吃飽時自我恢復",
        "不處於戰鬥 3 秒且飽食度至少 80% 時，每 0.5 秒消耗 2 飢餓值恢復 1 點生命值。汪達沒有生命值，改為獲得奔跑及消耗補償。需要主選項。",
    },
    mc_hunger_sprint =
    {
        "  跑步",
        "按住跑步鍵時速度提升 25%，汪達補償為 30%；每秒消耗 0.5 飢餓值，低於 20% 時停止。可在遊戲內設定按鍵，預設為左 Shift。需要主選項。",
    },
    mc_hunger_attack =
    {
        "  攻擊消耗",
        "每次成功命中消耗 0.33 飢餓值；範圍攻擊只結算一次，寵物不列入計算。需要主選項。",
    },
    mc_hunger_work =
    {
        "  勞動消耗",
        "挖掘、砍伐、採礦、採集及錘擊每次消耗 0.2 飢餓值。需要主選項。",
    },
    mc_hunger_skills =
    {
        "  技能與角色飢餓規則",
        "啟用角色專屬施法／製作消耗、自然飢餓加速和沃爾特攻擊消耗加成。需要主選項。",
    },
    mc_hunger_debuff =
    {
        "  生物飢餓效果",
        "殭屍命中會施加 10 秒飢餓，每秒額外消耗 1 點飢餓值，期間無法消耗飢餓值來恢復生命值。重複命中會刷新時間，不會疊加。需要主選項。",
    },
}

local L = cht and
{
    name = "MineStarve 當個挨餓神",
    description = [[
...
- 新增飾品欄
- 可選擇啟用神秘遺物
- 新增無上限玩家經驗、書／附魔書和九種 Minecraft 附魔；靈子分解器支援隨機附魔及附魔書／裝備犧牲轉移，含三種不同書籍的書櫃提供增幅，製圖桌增加砂輪功能
- 可單獨啟用或關閉 Minecraft 風格狀態欄；關閉時保留 DST 原版狀態欄
    ...
    extra_equipment =
    {
        ...
        disabled = "關閉",
        disabled_hover = "衣物和啟迪之冠恢復原版裝備欄佔用規則。",
    },
    mysterious_relics =
    {
        label = "神秘遺物",
        hover = "獲得更多飾品，以及一點「小小」的負面效果。",
        enabled = "啟用",
    ...
    {
        label = "Minecraft 怪物生成",
        hover = "控制苦力怕、骷髏和殭屍在地表與洞穴的自然生成。",
        none = "無",
        none_hover = "不自然生成 Minecraft 怪物。",
        default = "預設",
        default_hover = "保留每日上限和存在上限。",
        abundant = "大量",
        abundant_hover = "沒有每日上限，存在數量達上限後停止生成；洞穴的存在上限為地表的兩倍。",
    },
    hidden_curse =
    {
        label = "隱藏詛咒",
    ...
    hud_skin =
    {
        label = "更換為 Minecraft HUD 的首次預設值",
        hover =
            "僅用於首次建立各玩家的本地 HUD 設定；之後請在 Minecraft 物品欄右上角的設定介面中修改。",
        enabled = "是",
        enabled_hover = "首次預設啟用更換為 Minecraft HUD。",
        disabled = "否",
        disabled_hover = "保留原版 HUD 外觀，仍啟用擴充物品欄和 Minecraft 物品欄。",
    },
    functional_medal =
    {
        label = "隱藏能力勳章欄",
        ...
        enabled = "是",
        enabled_hover = "只在 Minecraft 物品欄中顯示。",
        disabled = "否",
        disabled_hover = "在原版物品欄和 Minecraft 物品欄中都顯示。",
    },
}
or chs and
{
